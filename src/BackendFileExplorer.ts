...
export class FileSystemProvider implements vscode.TreeDataProvider<Entry>, vscode.FileSystemProvider {
	...
	getTreeItem(element: Entry): vscode.TreeItem {
		...
		if (element.type === vscode.FileType.File) {
			treeItem.command = { command: 'BackendFileExplorer.openFile', title: "Open File", arguments: [element.uri], };
...
export class BackendFileExplorer {
	...
	constructor(context: vscode.ExtensionContext) {
		...
		this.view = vscode.window.createTreeView('BackendFileExplorer', { treeDataProvider: this.treeDataProvider , showCollapseAll: true});
		
		context.subscriptions.push(this.view);		
		vscode.commands.registerCommand('ayxBackend.debugEntryBackend', 
			() => this.startDebugging()
		);
		vscode.commands.registerCommand('BackendFileExplorer.openFile', (resource) => this.openResource(resource));
		vscode.commands.registerCommand('BackendFileExplorer.refreshFile', () => this.treeDataProvider.refresh());
	}
